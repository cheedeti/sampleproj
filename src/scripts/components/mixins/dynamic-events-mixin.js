...
import requires from 'remix-common/lib/utils/contract/requires';
import assert from 'remix-common/lib/utils/contract/assert';
...
export default {
    emit(eventName, ...initialArgs) {
        ...
        return (...eventArgs) => {
            const handler = this.props.onEvent;
